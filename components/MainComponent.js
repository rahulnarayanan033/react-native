...
class Main extends Component {
    componentDidMount(){
        ...
        Netinfo.fetch()
    .then((connectionInfo) =>{ToastAndroid.show('Initial Network Connectivity Type: ' + connectionInfo.type , ToastAndroid.LONG)
        });

        window.value = Netinfo.addEventListener(connectionChange => this.handleConnectivity(connectionChange))
